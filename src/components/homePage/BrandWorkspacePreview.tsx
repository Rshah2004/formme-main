        ...
        <div className="brand-workspace-body">
          ...
          <div className="brand-workspace-panel" id="workspace-panel" role="tabpanel" aria-labelledby={`workspace-tab-${view}`} tabIndex={0}>
            ...
            {view === 'approval' && <>
              ...
              <div className="workspace-sample-card"><figure className="is-photo"><span className="workspace-sketch-label">SAMPLE 02</span><img src="/images/blue-shirt-editorial.jpg" alt="Sky-blue everyday shirt, photographed on a rail" /><figcaption>Illustrative sample</figcaption></figure><div><h3>The everyday shirt</h3><p>You asked for a narrower cuff.<br />Here’s the revision.</p><div className="workspace-cuff-comparison" aria-label="Example cuff revision from 10.5 centimetres to 9 centimetres"><div><span>Previous cuff</span><del>10.5<small> cm</small></del></div><ArrowRight size={17} aria-hidden="true" /><div><span>Revised cuff</span><strong>9.0<small> cm</small><Check size={13} aria-hidden="true" /></strong></div></div></div></div>
